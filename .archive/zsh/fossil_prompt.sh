...
ZSH_THEME_FOSSIL_PROMPT_PREFIX="%{$fg[green]%}fossil%{$fg[white]%}: %{$fg[blue]%}(%{$fg[yellow]%}"

# At the very end of the prompt
ZSH_THEME_FOSSIL_PROMPT_SUFFIX="%{$fg[blue]%})"

# Text to display if the branch is dirty
ZSH_THEME_FOSSIL_PROMPT_DIRTY=" %{$fg[red]%}✖"

# Text to display if the branch is clean
ZSH_THEME_FOSSIL_PROMPT_CLEAN=" %{$fg[green]%}✔"
