...
# Nushell
echo ''
link_config "${nushell}/env.nu"        "${nushellConf}/env.nu"                 "nushell env"
link_config "${nushell}/config.nu"     "${nushellConf}/config.nu"              "nushell config"
