...
ln -sf "${completionArch}/_tr" "${zshcomp}/_tr"                                && echo "Installed completions ${BIYELLOW}=>${NC} ${BCYAN}tr${NC}"
ln -sf "${completionArch}/_zel" "${zshcomp}/_zel"                              && echo "Installed completions ${BIYELLOW}=>${NC} ${BCYAN}zel${NC}"
