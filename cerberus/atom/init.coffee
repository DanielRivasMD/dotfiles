...
atom.commands.add 'atom-text-editor',
  ...
  'custom:insert-julia_debug': -> atom.workspace.getActiveTextEditor()?.insertText('@debug ')
  ...
  'custom:insert-julia_eval': -> atom.workspace.getActiveTextEditor()?.insertText('@eval ')
  ...
  'custom:insert-idea': -> atom.workspace.getActiveTextEditor()?.insertText('IDEA: ')
