...
atom.commands.add 'atom-text-editor',
  ...
  'custom:insert-r_param': -> atom.workspace.getActiveTextEditor()?.insertText('@param')
  'custom:insert-r_return': -> atom.workspace.getActiveTextEditor()?.insertText('@return')
  'custom:insert-r_import': -> atom.workspace.getActiveTextEditor()?.insertText('@importFrom')
  'custom:insert-r_examples': -> atom.workspace.getActiveTextEditor()?.insertText('@examples')
  'custom:insert-r_rdname': -> atom.workspace.getActiveTextEditor()?.insertText('@rdname')
  'custom:insert-r_export': -> atom.workspace.getActiveTextEditor()?.insertText('@export')
